    ...
    var echartsApp = [], options = [
      //今日流量趋势
      {
        ...
        series : [{
          ...
          data: [0,0,0,0,0,15,60,317,436,385,362,263,116,42,0,0,24,61,167,248,289,375,464,387,201,138,31,0,0,0,0,0,0,0]
        },{
          name:'UV',
          type:'line',
          smooth:true,
          itemStyle: {normal: {areaStyle: {type: 'default'}}},
          data: [0,0,0,0,0,3,10,60,80,75,73,50,13,3,0,0,5,13,35,45,50,73,84,73,30,15,5,0,0,0,0,0,0,0]
        }]
      },
